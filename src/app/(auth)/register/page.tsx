      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white dark:bg-gray-900 overflow-y-auto">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-400">Join thousands making their city better</p>
          </div>
          ...
          <div className="flex gap-2 mb-8 bg-gray-100 dark:bg-gray-800 rounded-lg p-1">
            ...
            <button className="flex-1 px-4 py-2 bg-teal-500 text-white rounded-md font-medium transition-all">
              Sign Up
            </button>
          </div>
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
              >
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
